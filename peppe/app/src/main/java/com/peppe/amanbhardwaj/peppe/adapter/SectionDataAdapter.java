...
import com.peppe.amanbhardwaj.peppe.landingpagemodels.SectionDataModel;
...
public class SectionDataAdapter extends RecyclerView.Adapter<SectionDataAdapter.ItemRowHolder> {
    ...
    public SectionDataAdapter(Context context, List<SectionDataModel> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.section_item, null);
